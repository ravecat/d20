defmodule D20Web.ConnCase do
  ...
  by setting `use D20Web.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = D20.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    D20.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
