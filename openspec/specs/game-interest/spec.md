# game-interest Specification

## Purpose
Record account demand for online game availability and present authoritative requester state and counts without changing launch policy.
