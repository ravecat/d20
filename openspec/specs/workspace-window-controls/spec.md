...
The shell MUST retain native button semantics, result-oriented accessible names, decorative icon hiding, visible focus, pointer and disabled states, `1.875rem` square control geometry, `0.9375rem` square icons, a `0.3rem` inter-control gap, and the Theater group's `0.4rem` logical top-end offsets.
...
- **THEN** every control is a `1.875rem` square
- **AND** every control SVG is a `0.9375rem` square
