# storybook-page-shell Specification

## Purpose

Define how complete routed Storybook pages reuse the production application shell, route labels, deterministic shared context, and modal scrolling behavior.
