# app-footer-placement Specification

## Purpose
Keep footer content at the bottom of short App-layout pages while preserving natural sizing and document scrolling on long pages.
## Requirements
