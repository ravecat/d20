# session-actor-registry Specification

## Purpose

Define the process-owned actor-to-Session attachment index used for authoritative Workspace discovery independently from retained membership and transient Presence.
