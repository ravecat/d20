# External Provider Identity Foundation Specification

## Purpose

Define the provider-neutral persistence and Accounts boundary for linking, resolving, listing, and deleting external identities without retaining provider credentials or profile payloads.
