...
Define deterministic three-viewport visual comparison of Storybook-rendered D20 states through the existing Vitest Browser toolchain, including native review evidence, explicit reference acceptance, and preservation of existing non-visual coverage.
