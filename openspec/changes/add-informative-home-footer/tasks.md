...
- [ ] 6.4 Integrate the operator-authorized current styling, policy preparation and Privacy deferral into local master after candidate validation; verify the integrated target and reconcile the increment without closing unfinished feature/publication tasks.
