...
- Let the workspace component arrange expanded and compact windows with parent-owned CSS while keeping compact windows reachable.
...
- Frontend implementation: the `widgets/workspace` slice, App layout composition, page public APIs, workspace model and state types, workspace layout CSS, window components, and their mirrored focused tests.
