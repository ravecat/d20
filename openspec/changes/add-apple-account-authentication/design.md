...
Storybook imports the production Account Settings, Registration Completion, and Auth Confirmation page components and supplies typed page props for their meaningful server-owned states. Account Settings covers an established account and username claiming with provider availability differences. Registration Completion covers Magic Link and Apple server-cookie completion, including the provider cancel action. Auth Confirmation covers regular sign-in and sudo reauthentication.
