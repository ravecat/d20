...
- **WHEN** the page receives provider-only details with can_launch_game false, schema null, and session null
- **THEN** it renders existing metadata and description without a launch form, Play control, or Lobby
- **AND** no replacement CTA or disabled Play is introduced
